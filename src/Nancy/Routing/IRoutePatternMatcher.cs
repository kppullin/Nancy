namespace Nancy.Routing
{
    ...
    public interface IRoutePatternMatcher
    {
        ...
        /// </summary>
        /// <param name="requestedPath">The path that was requested, split on the '/' character into segments.</param>
        ...
        IRoutePatternMatchResult Match(string[] requestedPathSegments, string routePath);
    }
}